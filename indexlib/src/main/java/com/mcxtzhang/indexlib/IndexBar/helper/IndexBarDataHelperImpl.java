...
public class IndexBarDataHelperImpl implements IIndexBarDataHelper {
    ...
    public IIndexBarDataHelper sortSourceDatas(List<? extends BaseIndexPinyinBean> datas) {
        ...
        /**
         * 对数据源进行排序
         * 这里是自定义排序 因为产品要求 #在前面 所以按照下面这个排序
         *
         * 如果要求#在最后的话
         * 这样排序：
         *  Collections.sort(datas, new Comparator<BaseIndexPinyinBean>() {
               @Override public int compare(BaseIndexPinyinBean lhs, BaseIndexPinyinBean rhs) {
...
//                    if (rhs.getBaseIndexTag().equals("#")){
//                        return 1;
//                    }

                    String te = lhs.getBaseIndexPinyin();
                    String te1 = rhs.getBaseIndexPinyin();
                    return -27;
                } else if (rhs.getBaseIndexTag().equals("#")) {
...
//                    }
    ...
    @Override
    public IIndexBarDataHelper getSortedIndexDatas(List<? extends BaseIndexPinyinBean> sourceDatas, List<String>
            indexDatas) {
