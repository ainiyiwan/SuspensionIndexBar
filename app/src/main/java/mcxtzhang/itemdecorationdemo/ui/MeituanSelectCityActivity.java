...
import com.mcxtzhang.indexlib.IndexBar.widget.MyIndexBarCenter;
...
public class MeituanSelectCityActivity extends AppCompatActivity {
     ...
     * 右侧边栏导航区域
     */
    private MyIndexBarCenter mIndexBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIndexBar = (MyIndexBarCenter) findViewById(R.id.indexBar);//IndexBar
